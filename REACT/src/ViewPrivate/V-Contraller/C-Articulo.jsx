...
import { Post, TrueModal } from './0-Componentes'
...
export const Articulo = () => {
    ...
    const Enviar = () =>{
        if (request.costo == "") {
          ...
          if (Data[0] == null) {
            alert('Seleciona un catalogo');
            return;
          }
          if (Data[1] == null) {
            alert('Seleciona una categoría');
            return;
          }
          if (Data[2] == null) {
            alert('Seleciona un provedor');
            return;
          }
          if (Data[3] == null) {
            alert('Seleciona un fuente');
            return;
          }
          if (Data[4] == null) {
            alert('Seleciona un area');
            return;
          }
          if (Data[5] == null) {
            alert('Seleciona un rol');
            return;
          }
          if (Data[6] == null) {
            alert('Seleciona un responsable');
            return;
          }
    ...
    const EnviarDatos = async (Item) =>{
      const Mensaje = await Post({Entidad:"Artículo", Datos:Item})
      if(!Mensaje.success){
